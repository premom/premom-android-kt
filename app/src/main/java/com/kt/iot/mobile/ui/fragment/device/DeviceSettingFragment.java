...
public class DeviceSettingFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        headers.put("Authorization","Bearer "+ ApplicationPreference.getInstance().getPrefAccessToken());
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(mDevice != null) {
            ...
            if(!TextUtils.isEmpty(mDevice.getAtcFileNm())){
                ...
                String uriTemplate = "http://iotmakers.olleh.com/api/v1/devices/%s/%s/image/%s";
